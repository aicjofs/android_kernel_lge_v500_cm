...
#ifdef CONFIG_CPU_OVERCLOCK
	{ 1, {  1782000, HFPLL, 1, 0x42 }, L2(14), 1200000 },
#endif
	{ 0, { 0 } }
};
...
#ifdef CONFIG_CPU_OVERCLOCK
	{ 1, {  1782000, HFPLL, 1, 0x42 }, L2(14), 1050000 },
#endif
	{ 0, { 0 } }
};
...
static int __init acpuclk_8064_probe(struct platform_device *pdev)
{
 ...
 #if defined(CONFIG_MACH_APQ8064_L05E) || defined(CONFIG_MACH_APQ8064_GVAR_CMCC) || defined(CONFIG_MACH_APQ8064_AWIFI)
